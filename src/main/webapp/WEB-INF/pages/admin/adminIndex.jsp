...
<div class="layuimini-container">
    <div class="layuimini-main">
        ...
        <script type="text/html" id="currentTableBar">
            <a class="layui-btn layui-btn-normal layui-btn-xs data-count-edit" lay-event="updatePwd">Change password</a>
    ...
    layui.use(['form', 'table'], function () {
        ...
        table.render({
            ...
            cols: [[
                ...
                {field: 'type', width: 280, title: 'Administrator type',
                    templet:function(res){//类型
                        if(res.type=='0'){
                            return '<span>General administrator</span>'
                        } else{
                            return '<span>Senior administrator </span>'
                        }
                    }},
