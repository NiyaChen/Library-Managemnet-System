...
<%@ page isELIgnored="false" %><!-- 解析代码确保页面中的${info.id}和${info.name}这样的 EL 表达式能够正确地被解析，并在页面上显示出相应的数据。-->
...
<div class="layui-form layuimini-form">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            ...
            <tip>Fill in the name of type.</tip>
        </div>
    </div>
    ...
    <div class="layui-form-item">
        <div class="layui-input-block">
            <button class="layui-btn layui-btn-normal" lay-submit lay-filter="saveBtn">Confirm modify</button>
        </div>
    </div>
</div>
