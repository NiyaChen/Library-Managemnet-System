...
<head>
    <meta charset="utf-8">
    <title>Backend management system front-end template</title>
        ...
        <div class="layuimini-header-content" >
            ...
            <ul class="layui-nav layui-layout-left layuimini-header-menu layuimini-mobile-show">
                <li class="layui-nav-item">
                    <a href="javascript:;"><i class="fa fa-list-ul"></i> selecting template</a>
            ...
            <ul class="layui-nav layui-layout-right ">
                ...
                <li class="layui-nav-item layuimini-setting">
                    ...
                    <dl class="layui-nav-child">
                        ...
                        <dd>
                            <a href="javascript:;" layuimini-content-href="page/user-password.html" data-title="Modify Password" data-icon="fa fa-gears">Modify Password</a>
                        </dd>
                        <dd>
                            <hr>
                        </dd>
...
//      });
        ...
        $('.login-out').on("click", function () {
            layer.msg('Log out successful', function () {
